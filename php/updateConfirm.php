...
<body>
  ...
  $sql = "UPDATE t_member SET name='$name', explanation='$explanation', atk='$atk', def='$def', spd='$spd', hp='$hp', mp='$mp', skill1='$skill1', skill2='$skill2', skill3='$skill3', skill4='$skill4', skill5='$skill5', skill6='$skill6' WHERE id=$id";
  //SQLをセッションに格納
  $_SESSION['sql'] = $sql;
  ?>
